    ...
    <div class="container mt-5 me-5 mb-5">
        <div class="row mt-5">   
            <p class="col-lg-6">
                ...
                dan moet je met je koning weglopen of een stuk tussen je koning en de aanvaller zetten (of het aanvallende stuk slaan), zodat je koning niet meer aangevallen staat. 
                Als de koning aangevallen staat en niet meer kan vluchten, dan sta je schaakmat en verlies je. 
                Dit maakt de koning een kwetsbaar en belangrijk stuk. Je moet hem dus goed beschermen!
            </p>
        ...
        <div class="row">
            ...
            <p class="col-lg-6">
                De dame (ook wel koningin) mag meerdere velden in alle richtingen (wel via een rechte lijn, dus horizontaal, verticaal, of diagonaal) lopen en slaan. 
                Dit maakt de dame dus een erg sterk stuk. 
                Je hebt er echter maar 1, dus wees er altijd zuinig op.
            </p>
        </div>
        <div class="row">
            <p class="col-lg-6">
        ...
        <div class="row">
            <img class="col-lg-6" src="images/knight.png" style="width: 15%; height:auto">
            <p class="col-lg-6">
        ...
        <div class="row">
            <p class="col-lg-6">
                ...
                Pionnen kunnen alleen schuin vooruit slaan. 
                Ze kunnen dus enkel het veld links of rechts schuin voor hen slaan.
            </p>
            <img class="col-lg-6" src="images/pawn.png" style="width: 15%; height:auto">
        </div>
